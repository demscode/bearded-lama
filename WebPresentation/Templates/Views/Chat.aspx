<%@ Page Title="Home" Language="C#" MasterPageFile="~/Templates/Container.Master" AutoEventWireup="true" CodeBehind="Chat.aspx.cs" Inherits="WebPresentation.Views.Index" %>
<%@ Register TagPrefix="cc" TagName="Chat" 
    Src="~/Templates/UserControls/ChatBox.ascx" %>
